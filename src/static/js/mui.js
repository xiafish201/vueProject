...
(function($, window, undefined) {
	...
	var inspect = function(data, xhr, settings) {
        if (settings.inspect.call(settings.context, data, xhr, settings) === false) {
            return false;
        }
    };
	var ajaxSuccess = function(data, xhr, settings) {
	    if(inspect(data, xhr, settings) === false){
	        return false;
	    }
	...
	var ajaxError = function(error, type, xhr, settings) {
	    settings.inspecterror = error;
	    settings.inspecttype = type;
	    if(inspect('error', xhr, settings) === false){
            return false;
        }
